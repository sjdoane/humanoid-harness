...
validated through the firewall, held); Astra favors it (2026-09-07 15:02Z) as the next small scientific
   test ahead of another trainer diagnostic, pending a separately frozen
   protocol, an exact control, one data-only proposal and hand-over-risk
   rows, with the caveat that a deterministic pass or fall does not transfer
